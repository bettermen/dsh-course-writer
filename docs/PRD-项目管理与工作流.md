...
| **P7 收尾**（✅ 已完成） | i18n 补全（zh/en）、README 更新（zh/en）、版本号 0.8.0、构建 + 同步本机 DSH + 打 tag | `package.json` 0.8.0 + `README.md`/`README.en.md` + `i18n.ts` 补 `newPhaseName` | typecheck + build 全绿 + tag v0.8.0 |
